...
export function SocialBar() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50">
      <div className="bg-[#2d2d2d] rounded-t-3xl mx-4 mb-0 py-3 px-6">
        <div className="flex items-center justify-center gap-4">
          ...
          <a
            ...
            className="w-10 h-10 bg-[#ea4335] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
          >
