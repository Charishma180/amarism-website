      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          {paths.slice(0, 2).map((path) => {
            ...
            return (
              <div
                key={path.title}
                className="bg-white rounded-3xl p-8 md:p-10 text-center shadow-sm border border-gray-100"
              >
                <div className={`w-20 h-20 ${path.iconBg} rounded-full flex items-center justify-center mx-auto mb-6`}>
                ...
                <a
                  href={path.link}
                  className="block w-full bg-[#1a2e5a] hover:bg-[#10213f] text-white rounded-full py-4 font-semibold"
                >
                  Enroll Now
                </a>
              </div>
        ...
        <div className="md:max-w-xl mx-auto">
          <div className="bg-white rounded-3xl p-8 md:p-10 text-center shadow-sm border border-gray-100">
            <div className={`w-20 h-20 ${paths[2].iconBg} rounded-full flex items-center justify-center mx-auto mb-6`}>
              <Building2 className={`w-10 h-10 ${paths[2].iconColor}`} />
            </div>
