      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-start">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-8">
            Whether you want to volunteer your time, partner with us, or have a
            question, we are here to listen.
          </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-[#1a2e5a]">Phone Support</h3>
              <a
                href="tel:+917075428773"
                className="text-gray-600 text-sm hover:text-[#0d9488]"
              >
                +91 7075428773
              </a>
            </div>
